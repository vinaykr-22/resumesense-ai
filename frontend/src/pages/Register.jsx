    ...
    <div className="animate-fade-in" style={{ 
      ...
      <div style={{
        ...
        <div style={{ textAlign: 'center', marginBottom: '2.5rem' }}>
          ...
          <h1 style={{ fontSize: '2.25rem', marginBottom: '0.5rem' }}>Start your journey.</h1>
          <p style={{ color: 'var(--text-muted)' }}>Create an account to level up your resume.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
          ...
          <div>
            ...
            <input 
              ...
              minLength={8}
            />
            <p style={{ fontSize: '0.75rem', color: 'var(--text-muted)', marginTop: '0.5rem' }}>Must be at least 8 characters.</p>
          </div>
          <button 
            type="submit" 
            className="primary" 
        ...
        <p style={{ textAlign: 'center', marginTop: '2rem', fontSize: '0.9rem', color: 'var(--text-muted)' }}>
          ...
          <Link to="/login" style={{ color: 'var(--text)', transition: 'color 0.2s ease' }} onMouseOver={e => e.target.style.color = 'var(--accent)'} onMouseOut={e => e.target.style.color = 'var(--text)'}>
            Sign in &rarr;
          </Link>
        </p>
      </div>
